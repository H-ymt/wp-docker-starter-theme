...
class Ai1wmue_Main_Controller extends Ai1wmve_Main_Controller
{
  ...
  {
    add_action("admin_enqueue_scripts", [$this, "enqueue_export_scripts_and_styles"], 20);
    add_action("admin_enqueue_scripts", [$this, "enqueue_import_scripts_and_styles"], 20);
    add_action(
    ...
    add_action(
      "admin_enqueue_scripts",
      [$this, "enqueue_settings_scripts_and_styles"],
      20,
    );
  }
  ...
  public function ai1wmve_wp_cli()
  {
    if (defined("WP_CLI")) {
      WP_CLI::add_command("ai1wm", "Ai1wm_Backup_WP_CLI_Command", [
        ...
        "before_invoke" => [$this, "activate_extension_commands"],
      ]);
    }
  }
  ...
  public function enqueue_import_scripts_and_styles($hook)
  {
    ...
    add_action("admin_print_scripts", [$this, "google_tag_manager"]);
  }
  ...
  public function enqueue_settings_scripts_and_styles($hook)
  {
    ...
    wp_localize_script("ai1wmue_settings", "ai1wm_feedback", [
      "ajax" => [
    ...
    wp_localize_script("ai1wmue_settings", "ai1wmue_folder_browser", [
      "ajax" => [
        "url" => wp_make_link_relative(
          admin_url("admin-ajax.php?action=ai1wmue_folder_browser"),
        ),
      ],
      "secret_key" => get_option(AI1WM_SECRET_KEY),
    ]);

    wp_localize_script("ai1wmue_settings", "ai1wmue_locale", [
      ...
      "empty_list_message" => __(
        "No folders to list. Click on the navbar to go back.",
        AI1WMUE_PLUGIN_NAME,
      ),
  ...
  public function router()
  {
    if (current_user_can("export")) {
      add_action(
        "wp_ajax_ai1wmue_folder_browser",
        "Ai1wmue_Settings_Controller::list_folders",
      );
    }
  }
  ...
  public function plugin_row_meta($links, $file)
  {
    if ($file === AI1WMUE_PLUGIN_BASENAME) {
      $links[] = __(
        '<a href="https://help.servmask.com/knowledgebase/unlimited-extension-user-guide/" target="_blank">User Guide</a>',
        AI1WMUE_PLUGIN_NAME,
      );
      $links[] = __(
        '<a href="https://servmask.com/contact-support" target="_blank">Contact Support</a>',
        AI1WMUE_PLUGIN_NAME,
      );
    }
  ...
  {
    Ai1wm_Template::render("common/google-tag-manager", [], AI1WMUE_TEMPLATES_PATH);
  }
}
