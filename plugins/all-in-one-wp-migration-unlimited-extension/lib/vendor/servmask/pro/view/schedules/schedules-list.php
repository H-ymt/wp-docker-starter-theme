...
<table class="ai1wmve-schedules">
	...
	<tbody class="ai1wmve-schedules-empty <?php echo count($events) > 0
   ? ""
   : "ai1wmve-schedules-empty-show"; ?>">
		<tr>
			<td colspan="6">
      ...
      add_query_arg(
        ["action" => "create-event"],
        network_admin_url("admin.php?page=ai1wmve_schedules"),
      ),
    ); ?>">
	...
	<tbody class="ai1wmve-schedules-list">
		...
		<tr>
			...
			<td class="ai1wm-column-status ai1wm-column-status-<?php echo strtolower(
     $event->status(),
   ); ?>">
			...
			<td class="ai1wm-column-last-run ai1wm-column-last-run-<?php echo strtolower(
     $event->last_run(),
   ); ?>"">
			...
			<td class="ai1wm-column-actions ai1wmve-schedule-actions">
				<div>
					<a href="#" role="menu" aria-haspopup="true" class="ai1wmve-schedule-dots" title="<?php _e(
       "More",
     ); ?>" aria-label="<?php _e("More"); ?>">
						<i class="ai1wm-icon-dots-horizontal-triple"></i>
					</a>
					<div class="ai1wmve-schedule-dots-menu">
						<ul role="menu">
							<li>
								<a tabindex="-1" href="#" data-event_id="<?php echo esc_attr(
          $event->event_id(),
        ); ?>" role="menuitem" aria-label="<?php _e(
  "Start",
  AI1WM_PLUGIN_NAME,
); ?>" class="ai1wmve-schedule-start">
          ...
          add_query_arg(
            ["action" => "edit-event", "event_id" => $event->event_id()],
            network_admin_url("admin.php?page=ai1wmve_schedules"),
          ),
        ); ?>" role="menuitem" aria-label="<?php _e(
  "Edit",
  AI1WM_PLUGIN_NAME,
); ?>" class="ai1wmve-schedule-edit">
							...
							<li>
								<a tabindex="-1" href="#" data-event_id="<?php echo esc_attr(
          $event->event_id(),
        ); ?>" data-event_title="<?php echo esc_attr(
  $event->title(),
); ?>" role="menuitem" aria-label="<?php _e(
  "View log",
  AI1WM_PLUGIN_NAME,
); ?>" class="ai1wmve-schedule-view-log">
