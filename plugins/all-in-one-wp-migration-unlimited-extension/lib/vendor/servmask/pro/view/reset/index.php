			...
			<div class="ai1wm-holder" id="ai1wm-reset-tools">
				...
				<div class="ai1wm-tool-container ai1wm-tools">
					...
					<div class="ai1wm-btn-container">
						<a href="#ai1wm-reset-plugins" class="ai1wm-btn"><i class="ai1wm-icon-power-cord"></i> <?php _e(
        "Plugin Purge",
        AI1WM_PLUGIN_NAME,
      ); ?></a>
					</div>
					...
					<div class="ai1wm-btn-container">
						<a href="#ai1wm-reset-themes" class="ai1wm-btn"><i class="ai1wm-icon-stack"></i> <?php _e(
        "Theme Reset",
        AI1WM_PLUGIN_NAME,
      ); ?></a>
					</div>
					...
					<div class="ai1wm-btn-container">
						<a href="#ai1wm-reset-media" class="ai1wm-btn"><i class="ai1wm-icon-image"></i> <?php _e(
        "Media Clean-Up",
        AI1WM_PLUGIN_NAME,
      ); ?></a>
					</div>
					...
					<div class="ai1wm-btn-container">
						<a href="#ai1wm-reset-database" class="ai1wm-btn"><i class="ai1wm-icon-database"></i> <?php _e(
        "Database Reset",
        AI1WM_PLUGIN_NAME,
      ); ?></a>
					</div>
					...
					<div class="ai1wm-btn-container">
						<a href="#ai1wm-reset-all" class="ai1wm-btn"><i class="ai1wm-icon-file-zip"></i> <?php _e(
        "Full Site Reset",
        AI1WM_PLUGIN_NAME,
      ); ?></a>
					</div>
				...
				<reset-confirmation
						please-remember-html="<?php esc_attr_e(
        __(
          '<strong><i class="ai1wm-icon-notification"></i> Please remember:</strong> Always <a href="#" class="ai1wm-show-create-snapshot-link">create a backup</a> before proceeding, so you can undo these changes if needed.',
          AI1WM_PLUGIN_NAME,
        ),
      ); ?>"
						confirm-password-label="<?php esc_attr_e(
        __("To confirm, enter your current password:", AI1WM_PLUGIN_NAME),
      ); ?>"
						password-placeholder="<?php esc_attr_e(
        sprintf(
          _x("Enter password for %s", "password for the current user", AI1WM_PLUGIN_NAME),
