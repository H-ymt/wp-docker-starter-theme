...
if (!class_exists("Ai1wmve_Schedule_Events")) {
  class Ai1wmve_Schedule_Events
  {
    ...
    {
      return array_filter($this->all(), function ($event) {
    ...
    public function save($data)
    {
      ...
      $event->clear_schedule()->create_schedule();
    ...
    public function find_or_new($id)
    {
      ...
      return new Ai1wmve_Schedule_Event([]);
    }

    public function delete($id)
    {
      if ($event = $this->find($id)) {
        $event->clear_schedule()->delete_data();
      ...
      throw new Ai1wmve_Schedules_Exception(
        __("Unable to find scheduled event", AI1WM_PLUGIN_NAME),
      );
    }
