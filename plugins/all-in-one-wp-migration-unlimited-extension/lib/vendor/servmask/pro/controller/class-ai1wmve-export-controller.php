...
if (!class_exists("Ai1wmve_Export_Controller")) {
  class Ai1wmve_Export_Controller
  {
    ...
    {
      Ai1wm_Template::render("export/inactive-themes", [], AI1WMVE_TEMPLATES_PATH);
    }

    public static function inactive_plugins()
    {
      Ai1wm_Template::render("export/inactive-plugins", [], AI1WMVE_TEMPLATES_PATH);
    }

    public static function cache_files()
    {
      Ai1wm_Template::render("export/cache-files", [], AI1WMVE_TEMPLATES_PATH);
    }
    ...
    {
      Ai1wm_Template::render("export/exclude-files", [], AI1WMVE_TEMPLATES_PATH);
    }

    public static function list_files($params = [])
    {
      ...
      if (is_dir(WP_CONTENT_DIR . DIRECTORY_SEPARATOR . $folder_path)) {
        ...
        $iterator = new Ai1wm_Recursive_Directory_Iterator(
          WP_CONTENT_DIR . DIRECTORY_SEPARATOR . $folder_path,
        );
