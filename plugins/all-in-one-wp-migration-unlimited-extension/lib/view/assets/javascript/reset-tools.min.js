  ...
  var t = {
      9553: function (t, e, n) {
        ...
        (i.prototype.setParams = function (t) {
          this.params = Ai1wm.Util.list(t);
        }),
          (i.prototype.start = function (t, e) {
            var n = this;
            if ((0 === (e = e || 0) && this.stopReset(!1), !this.isResetStopped())) {
              o(window).bind("beforeunload", function () {
                return ai1wmve_locale.stop_resetting_your_website;
              }),
                this.setStatus({
                  type: "info",
                  message: ai1wmve_locale.reset_in_progress_info,
                });
              var r = this.params.concat({
                name: "secret_key",
                value: ai1wm_reset.secret_key,
              });
              t && (r = r.concat(Ai1wm.Util.list(t))),
                o
                  .ajax({
                    url: ai1wm_reset.ajax.url,
                    type: "POST",
                    dataType: "json",
                    data: r,
                  ...
                  .fail(function (r) {
                    var o = 1e3 * e;
                    try {
                      var i = Ai1wm.Util.json(r.responseText);
                      if (i) {
                        var s = JSON.parse(i).errors.pop();
                        if (s.message)
                          return (
                            n.stopReset(!0),
                            void n.setStatus({
                              type: "error",
                              title: ai1wmve_locale.unable_to_reset,
                              message: s.message,
                            })
                          );
                      }
                    ...
                    if (e >= 5)
                      return (
                        ...
                        void n.setStatus({
                          type: "error",
                          title: ai1wmve_locale.unable_to_reset,
                          message: ai1wmve_locale.unable_to_start_the_reset,
                        })
                      );
                    e++, setTimeout(n.start.bind(n, t, e), o);
                  });
            }
          }),
                    ...
                    if (e >= 5)
                      return (
                        ...
                        void n.setStatus({
                          type: "error",
                          title: ai1wmve_locale.unable_to_reset,
                          message: ai1wmve_locale.unable_to_stop_the_reset,
                        })
                      );
                    e++, setTimeout(n.run.bind(n, t, e), o);
                  });
          }),
          (i.prototype.getStatus = function () {
            ...
            this.isResetStopped() ||
              (this.statusXhr = o
                ...
                .done(function (e) {
                  if (e)
                    switch ((t.setStatus(e), e.type)) {
                      case "done":
                      case "error":
                        return void o(window).unbind("beforeunload");
                    }
                  setTimeout(t.getStatus.bind(t), 3e3);
                })
                .fail(function () {
                  setTimeout(t.getStatus.bind(t), 3e3);
                }));
          ...
          (i.prototype.setStatus = function (t) {
            switch (t.type) {
              case "info":
                r.Z.$emit("change-reset-loader-text", t);
                break;
              case "done":
                r.Z.$emit("change-reset-loader-done", t);
                break;
              case "error":
                r.Z.$emit("change-reset-loader-error", t);
            }
          }),
          (i.prototype.stopReset = function (t) {
            try {
              t && this.statusXhr && this.statusXhr.abort();
            } finally {
              this.isStopped = t;
            }
          }),
          (i.prototype.isResetStopped = function () {
      ...
      4994: function (t, e, n) {
        ...
        t.exports = function (t, e, n, u) {
          var l = e + " Iterator";
          return (
            (t.prototype = o(r, { next: i(+!u, n) })), s(t, l, !1, !0), (a[l] = c), t
          );
        };
      },
      8880: function (t, e, n) {
      ...
      654: function (t, e, n) {
        ...
        t.exports = function (t, e, n, s, h, v, A) {
          c(n, e, s);
          var k,
            O,
            T,
          ...
          if (
            (I &&
              (k = u(I.call(new t()))) !== Object.prototype &&
              k.next &&
              (i || u(k) === _ || (l ? l(k, _) : a(k[w]) || d(k, w, C)),
              f(k, P, !0, !0),
              i && (m[P] = C)),
            g &&
              h == x &&
            ...
            if (((O = { values: j(x), keys: v ? N : j($), entries: j(S) }), A))
              for (T in O) (b || E || !(T in M)) && d(M, T, O[T]);
            else r({ target: e, proto: !0, forced: b || E }, O);
          return (i && !A) || M[w] === N || d(M, w, N, { name: h }), (m[e] = N), O;
        };
      },
      9781: function (t, e, n) {
        var r = n(7293);
      ...
      9909: function (t, e, n) {
        ...
        if (s || p.state) {
          ...
          (h[$] = !0),
            (r = function (t, e) {
              if (f(t, $)) throw new v(m);
              return (e.facade = t), l(t, $, e), e;
            }),
            (o = function (t) {
              return f(t, $) ? t[$] : {};
            }),
      ...
      408: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          ...
          if (C) v = t.iterator;
            ...
            if (a(g)) {
              for (y = 0, _ = c(t); _ > y; y++) if ((b = j(t[y])) && u(m, b)) return b;
              return new h(!1);
            }
            v = l(t, g);
          }
          for (w = C ? t.next : v.next; !($ = o(w, v)).done; ) {
            try {
              b = j($.value);
            } catch (t) {
              p(v, "throw", t);
      ...
      3702: function (t, e, n) {
        var r = n(7854),
          ...
          v = s("Promise", function () {
            ...
            return (
              ((n.constructor = {})[d] = r),
              !(h = n.then(function () {}) instanceof r) || (!e && u && !m)
            );
          });
      ...
      5112: function (t, e, n) {
        ...
        t.exports = function (t) {
          if (!i(u, t) || (!a && "string" != typeof u[t])) {
            var e = "Symbol." + t;
            a && i(l, t) ? (u[t] = l[t]) : (u[t] = c && f ? f(e) : p(e));
          }
          return u[t];
        };
      },
        ...
        var r = n(2109),
          ...
          b = function (t, e) {
            ...
            s
              ...
              : ((n = a ? this : c(w)), u(n, g, "Error")),
              void 0 !== e && u(n, "message", h(e)),
              v && u(n, "stack", f(n.stack, 1)),
              p(n, r);
            var l = [];
            return d(t, _, { that: l }), u(n, "errors", l), n;
          };
      ...
      3401: function (t, e, n) {
          ...
          q = function (t) {
            l(b, u, function () {
              ...
              if (
                G(t) &&
                ((e = x(function () {
                  c ? B.emit("unhandledRejection", r, n) : J(Z, n, r);
                })),
                (t.rejection = c || G(t) ? 2 : 1),
                e.error)
              )
                throw e.value;
            });
        ...
        if (
          ...
          (O.f = U =
            function (t) {
              return t === I || void 0 === t ? new o(t) : z(t);
            }),
          !a && v(A) && N !== Object.prototype)
        ) {
          (i = N.then),
            E ||
              f(
      ...
      1317: function (t, e, n) {
        ...
        const C = /-(\w)/g,
          A = S((t) => t.replace(C, (t, e) => (e ? e.toUpperCase() : ""))),
          k = S((t) => t.charAt(0).toUpperCase() + t.slice(1)),
          O = /\B([A-Z])/g,
          T = S((t) => t.replace(O, "-$1").toLowerCase()),
        ...
        const X = new RegExp(`[^${Z.source}.$_\\d]`),
          J = "__proto__" in {},
        ...
        G && G.indexOf("android");
        const tt = G && /iphone|ipad|ipod|ios/.test(G);
        G && /chrome\/\d+/.test(G), G && /phantomjs/.test(G);
        const et = G && G.match(/firefox\/(\d+)/),
          nt = {}.watch;
        let rt,
          ot = !1;
        if (q)
        ...
        const kt = { notify: R, depend: R, addSub: R, removeSub: R };
        class Ot {
        ...
        function Tt(t, e, n) {
          if (!f(t) || Ft(t) || t instanceof pt) return;
          let r;
          return (
        ...
        function jt(t, e, n, r, o, s) {
          ...
          const u = c && c.get,
            l = c && c.set;
          (u && !l) || (n !== St && 2 !== arguments.length) || (n = t[e]);
          let f = !o && Tt(n, !1, s);
          return (
            Object.defineProperty(t, e, {
              enumerable: !0,
              ...
              get: function () {
                ...
                return (
                  gt.target && (a.depend(), f && (f.dep.depend(), i(e) && Mt(e))),
                  Ft(e) && !o ? e.value : e
                );
              },
              set: function (e) {
                ...
                if (B(r, e)) {
                  if (l) l.call(t, e);
                    ...
                    if (u) return;
                    if (Ft(r) && !Ft(e)) return void (r.value = e);
                    n = e;
                  }
        ...
        function Mt(t) {
          for (let e, n = 0, r = t.length; n < r; n++)
            (e = t[n]), e && e.__ob__ && e.__ob__.dep.depend(), i(e) && Mt(e);
        }
        function Rt(t) {
        ...
        function Zt(t, e) {
          ...
          K(t, n, o),
            ...
            (e || Lt(t)) && K(o, "__v_isShallow", !0);
          const i = Object.keys(t);
          for (let n = 0; n < i.length; n++) Ht(o, t, i[n], e);
          return o;
        }
        function Ht(t, e, n, r) {
          Object.defineProperty(t, n, {
        ...
        function Jt(t, e, n, r, o, i) {
          ...
          for (a in t)
            (u = t[a]),
              ...
              s(u) ||
                (s(l)
                  ? (s(u.fns) && (u = t[a] = Xt(u, i)),
                    c(f.once) && (u = t[a] = o(f.name, u, f.capture)),
        ...
        function Wt(t) {
          return u(t) ? [ht(t)] : i(t) ? Yt(t) : void 0;
        }
        function Qt(t) {
            ...
            (o = t[r]),
              s(o) ||
                ...
                i(o)
                  ? o.length > 0 &&
                    ((o = Yt(o, `${e || ""}_${r}`)),
                    Qt(o[0]) && Qt(f) && ((n[l] = ht(f.text + o[0].text)), o.shift()),
                    n.push.apply(n, o))
                  : u(o)
                    ? Qt(f)
                      ? (n[l] = ht(f.text + o))
            ...
            (function (t, e, n, r, o) {
              ...
              if (
                ...
                (c = (t.$vnode && t.$vnode.ns) || V.getTagNamespace(e)),
                  (s = V.isReservedTag(e)
                    ? new pt(V.parsePlatformTagName(e), n, r, void 0, void 0, t)
        ...
        function re(t, e, n, r) {
          ...
          let i;
          o
            ? ((n = n || {}), r && (n = E(E({}, r), n)), (i = o(n) || (l(e) ? e() : e)))
            : (i = this.$slots[t] || (l(e) ? e() : e));
          const s = n && n.slot;
          return s ? this.$createElement("template", { slot: s }, i) : i;
        }
        function oe(t) {
          return ar(this.$options, "filters", t) || I;
        }
        function ie(t, e) {
        ...
        function xe(t) {
          return {
            ...
            get slots() {
              return (function (t) {
                return (
                  t._slotsProxy || Ae((t._slotsProxy = {}), t.$scopedSlots), t._slotsProxy
                );
              })(t);
            },
            emit: j(t.$emit, t),
        ...
        function Se(t, e, n, r) {
          let o = !1;
          for (const i in e) i in t ? e[i] !== n[i] && (o = !0) : ((o = !0), Ce(t, i, r));
        ...
        function Ne(t, e, n) {
          (Oe = t), Jt(e, n || {}, Ee, Me, Re, t), (Oe = void 0);
        }
        let Ie = null;
        function Le(t) {
          const e = Ie;
        ...
        function Ge() {
          let t, e;
          for (
            Je = qe(), Ke = !0, ze.sort((t, e) => t.id - e.id), Xe = 0;
            Xe < ze.length;
            Xe++
          )
            (t = ze[Xe]), t.before && t.before(), (e = t.id), (Ze[e] = null), t.run();
          const n = Ve.slice(),
            r = ze.slice();
          (Xe = ze.length = Ve.length = 0),
            (Ze = {}),
            (He = Ke = !1),
            (function (t) {
        ...
        function tn(
          ...
          const g = new Mn(lt, p, R, { lazy: !0 });
          g.noRecurse = !e;
          let y = m ? [] : Ye;
          return (
            (g.run = () => {
              if (g.active || ("pre" === s && u && u._isBeingDestroyed))
                if (e) {
                  const t = g.get();
        ...
        function rn(t, e) {
          if (lt) {
            let n = lt._provided;
            const r = lt.$parent && lt.$parent._provided;
            r === n && (n = lt._provided = Object.create(r)), (n[t] = e);
          }
        }
        function on(t, e, n) {
          _t();
        ...
        var On = Object.freeze({
          ...
          computed: function (t, e) {
            ...
            const i = it() ? null : new Mn(lt, n, R, { lazy: !0 }),
              s = {
                effect: i,
                get value() {
                  return i
          ...
          if (
            ...
            (function (t) {
              ...
              if (n) {
                ...
                ft(t), _t();
                const o = sn(n, null, [t._props || Rt({}), r], t, "setup");
                if ((bt(), ft(), l(o))) e.render = o;
                else if (f(o))
                  if (((t._setupState = o), o.__sfc)) {
                    const e = (t._setupProxy = {});
                    for (const t in o) "__sfc" !== t && Ut(e, o, t);
                  } else for (const e in o) H(e) || Ut(t, o, e);
              }
            })(t),
            e.methods &&
              (function (t, e) {
                t.$options.props;
                for (const n in e) t[n] = "function" != typeof e[n] ? R : j(e[n], t);
              })(t, e.methods),
            e.data)
          )
            !(function (t) {
          ...
          e.computed &&
            (function (t, e) {
              ...
              for (const o in e) {
                const i = e[o],
                  s = l(i) ? i : i.get;
                r || (n[o] = new Mn(t, s || R, R, Ln)), o in t || Dn(t, o, i);
              }
            })(t, e.computed),
            e.watch &&
              e.watch !== nt &&
              (function (t, e) {
                for (const n in e) {
                  const r = e[n];
                  if (i(r)) for (let e = 0; e < r.length; e++) Un(t, n, r[e]);
                  else Un(t, n, r);
                }
              })(t, e.watch);
        }
        ...
        function Dn(t, e, n) {
          const r = !it();
          l(n)
            ? ((Rn.get = r ? Fn(e) : Bn(n)), (Rn.set = R))
            : ((Rn.get = n.get ? (r && !1 !== n.cache ? Fn(e) : Bn(n.get)) : R),
              (Rn.set = n.set || R)),
        ...
        function Hn(t, e, n, r, s) {
          ...
          let u;
          x(r, "_uid")
            ? ((u = Object.create(r)), (u._original = r))
            : ((u = r), (r = r._original));
          const l = c(a._compiled),
            f = !l;
          (this.data = t),
            (this.props = e),
            (this.children = n),
        ...
        const qn = {
            ...
            prepatch(t, e) {
              ...
              !(function (t, e, n, r, i) {
                ...
                if (
                  (t._attrsProxy &&
                    Se(t._attrsProxy, f, (l.data && l.data.attrs) || o, t) &&
                    (u = !0),
                  (t.$attrs = f),
                  (t.$listeners = n || o),
                  e && t.$options.props)
                ...
                (t.$options._parentListeners = n),
                  Ne(t, n, p),
                  u && ((t.$slots = ge(i, r.context)), t.$forceUpdate());
              })(
            ...
            insert(t) {
              ...
              var r;
              n._isMounted || ((n._isMounted = !0), Ue(n, "mounted")),
                t.data.keepAlive &&
                  (e._isMounted ? (((r = n)._inactive = !1), Ve.push(r)) : Fe(n, !0));
            },
            destroy(t) {
          ...
          Gn = Object.keys(qn);
        function Wn(t, e, n, r, u) {
          if (s(t)) return;
          const l = n.$options._base;
          if ((f(t) && (t = l.extend(t)), "function" != typeof t)) return;
          let p;
          if (
            s(t.cid) &&
            ((p = t),
            (t = (function (t, e) {
              ...
              if (n && !a(t.owners)) {
                ...
                const u = (t) => {
                  ...
                  l = F((n) => {
                    (t.resolved = je(n, e)), o ? (r.length = 0) : u(!0);
                  }),
                  p = F((e) => {
          ...
          if (c(t.options.functional))
            return (function (t, e, n, r, s) {
              const c = t.options,
                u = {},
                l = c.props;
              if (a(l)) for (const t in l) u[t] = cr(t, l, e || o);
              else a(n.attrs) && Xn(u, n.attrs), a(n.props) && Xn(u, n.props);
              const f = new Hn(n, u, s, r, t),
          ...
          return new pt(
            ...
            void 0,
            n,
            { Ctor: t, propsData: d, listeners: h, tag: u, children: r },
            p,
          );
        }
        function Qn(t, e) {
        ...
        let Yn = R;
        const tr = V.optionMergeStrategies;
        function er(t, e) {
          if (!e) return t;
          let n, r, o;
          ...
          for (let s = 0; s < i.length; s++)
            (n = i[s]),
              "__ob__" !== n &&
                ((r = t[n]),
                (o = e[n]),
                x(t, n) ? r !== o && d(r) && d(o) && er(r, o) : Pt(t, n, o));
          return t;
        }
        function nr(t, e, n) {
          return n
          ...
          if (
            ...
            (function (t, e) {
              ...
              if (i(n))
                for (o = n.length; o--; )
                  (s = n[o]),
                    "string" == typeof s && ((a = A(s)), (r[a] = { type: null }));
              else if (d(n))
                for (const t in n)
                  (s = n[t]), (a = A(t)), (r[a] = d(s) ? s : { type: s });
              t.props = r;
            })(e),
            (function (t, e) {
              const n = t.inject;
        ...
        const ur = /^\s*function (\w+)/;
        function lr(t) {
          const e = t && t.toString().match(ur);
          return e ? e[1] : "";
        }
        function fr(t, e) {
          return lr(t) === lr(e);
        ...
        function Vr(t, e) {
          ...
          const r = t.context,
            ...
            s = e ? null : o,
            c = e ? void 0 : o;
          if (l(n)) return void sn(n, r, [s], r, "template ref function");
                ...
                (u = o[c]),
                  ...
                  u
                    ? ((l.oldValue = u.value),
                      (l.oldArg = u.arg),
                      to(l, "update", e, t),
                      l.def && l.def.componentUpdated && a.push(l))
                    : (to(l, "bind", e, t), l.def && l.def.inserted && s.push(l));
              if (s.length) {
                const r = () => {
        ...
        function no(t, e) {
          ...
          f))
            (o = f[r]), (i = l[r]), i !== o && ro(u, r, o, e.data.pre);
          for (r in ((W || Y) && f.value !== l.value && ro(u, "value", f.value), l))
            s(f[r]) &&
              (kr(r) ? u.removeAttributeNS(Ar, Or(r)) : xr(r) || u.removeAttribute(r));
        }
        function ro(t, e, n, r) {
        ...
        function _o(t, e, n, r, i, s, a, c) {
          ...
          (r = r || o).right
            ...
            r.native
              ...
              : (u = t.events || (t.events = {}));
          const l = xo({ value: n.trim(), dynamic: c }, a);
          r !== o && (l.modifiers = r);
          const f = u[e];
          Array.isArray(f)
            ? i
        ...
        function Co(t, e) {
          const n = (function (t) {
            ...
            for (ko = t, To = jo = Po = 0; !Ro(); )
              (Oo = Mo()), No(Oo) ? Lo(Oo) : 91 === Oo && Io(Oo);
            return { exp: t.slice(0, jo), key: t.slice(jo + 1, Po) };
          })(t);
          return null === n.key ? `${t}=${e}` : `$set(${n.exp}, ${n.key}, ${e})`;
        }
        let Ao, ko, Oo, To, jo, Po, Eo;
        function Mo() {
        ...
        function zo(t, e) {
          ...
          (Eo = e.elm || t.elm),
            ...
            Jt(n, r, Bo, Uo, Do, e.context),
            (Eo = void 0);
        }
        var Vo = { create: zo, update: zo, destroy: (t) => zo(t, Hr) };
        let Zo;
        function Ho(t, e) {
          ...
          for (n in ((a(u.__ob__) || c(u._v_attr_proxy)) &&
            (u = e.data.domProps = E({}, u)),
          i))
            n in u || (o[n] = "");
          for (n in u) {
        ...
        function Go(t) {
          return Array.isArray(t) ? M(t) : "string" == typeof t ? Jo(t) : t;
        }
        const Wo = /^--/,
          Qo = /\s*!important$/,
          Yo = (t, e, n) => {
            ...
            let r;
            {
              ...
              for (; e.componentInstance; )
                (e = e.componentInstance._vnode),
                  e && e.data && (r = qo(e.data)) && E(n, r);
            }
            (r = qo(t.data)) && E(n, r);
            let o = t;
            for (; (o = o.parent); ) o.data && (r = qo(o.data)) && E(n, r);
            return n;
          })(e);
        ...
        function wi(t, e) {
          ...
          return (
            "transition" === e
              ? i > 0 && ((u = "transition"), (l = i), (f = o.length))
              : "animation" === e
                ? c > 0 && ((u = "animation"), (l = c), (f = a.length))
                : ((l = Math.max(i, c)),
                  (u = l > 0 ? (i > c ? "transition" : "animation") : null),
                  (f = u ? ("transition" === u ? o.length : a.length) : 0)),
            {
              type: u,
              timeout: l,
              propCount: f,
              hasTransform: "transition" === u && bi.test(n[fi + "Property"]),
            }
          );
        }
        function $i(t, e) {
        ...
        function Si(t, e) {
          ...
          const T = O && d ? d : c,
            ...
            B = (n._enterCb = F(() => {
              L && (yi(n, P), yi(n, j)),
                B.cancelled ? (L && yi(n, T), N && N(n)) : R && R(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            qt(t, "insert", () => {
            ...
            L &&
              ...
              vi(() => {
                yi(n, T),
                  B.cancelled ||
                    (gi(n, P), D || (Ai(I) ? setTimeout(B, I) : _i(n, i, B)));
              })),
            t.data.show && (e && e(), M && M(n, B)),
            L || D || B();
        }
        function Ci(t, e) {
          const n = t.elm;
          ...
          const {
            ...
            $ = (n._leaveCb = F(() => {
              n.parentNode &&
                ...
                _ && (yi(n, u), yi(n, l)),
                $.cancelled ? (_ && yi(n, c), m && m(n)) : (e(), h && h(n)),
                (n._leaveCb = null);
            }));
          function x() {
            $.cancelled ||
              ...
              _ &&
                ...
                vi(() => {
                  yi(n, c),
                    $.cancelled ||
                      (gi(n, u), b || (Ai(w) ? setTimeout($, w) : _i(n, i, $)));
                })),
              d && d(n, $),
              _ || b || $());
          }
        ...
        function ki(t) {
          if (s(t)) return !1;
          const e = t.fns;
          return a(e) ? ki(Array.isArray(e) ? e[0] : e) : (t._length || t.length) > 1;
        }
        function Oi(t, e) {
          !0 !== e.data.show && Si(e);
        }
        const Ti = (function (t) {
          ...
          function p(t, e, n, o, i, s, u) {
            if (
              (a(t.elm) && a(s) && (t = s[u] = mt(t)),
              (t.isRootInsert = !i),
              (function (t, e, n, o) {
                let i = t.data;
                if (a(i)) {
          ...
          function g(t, n) {
            for (let e = 0; e < r.create.length; ++e) r.create[e](Hr, t);
            (e = t.data.hook),
              a(e) && (a(e.create) && e.create(Hr, t), a(e.insert) && n.push(t));
          }
          function _(t) {
            let e;
                    ...
                    for (; d <= m && h <= y; )
                      s(v)
                        ...
                        : s(g)
                          ? (g = e[--m])
                          : Xr(v, _)
                            ? (C(v, _, r, n, h), (v = e[++d]), (_ = n[++h]))
                            : Xr(g, w)
                              ? (C(g, w, r, n, y), (g = e[--m]), (w = n[--y]))
                              : Xr(v, w)
                                ? (C(v, w, r, n, y),
          ...
          function O(t, e, n, r) {
            let o;
            const { tag: i, data: s, children: u } = e;
            if (
          ...
          return function (t, e, n, o) {
            ...
            if (s(t)) (i = !0), p(e, u);
              ...
              if (!i && Xr(t, e)) C(t, e, u, null, null, o);
              else {
                if (i) {
                  if (
                    (1 === t.nodeType &&
                ...
                const o = t.elm,
                  s = l.parentNode(o);
                if ((p(e, u, o._leaveCb ? null : s, l.nextSibling(o)), a(e.parent))) {
                  let t = e.parent;
                  const n = v(e);
                  for (; t; ) {
                ...
                a(s) ? $([t], 0, 0) : a(t.tag) && w(t);
              }
            }
            var f;
            return A(e, u, i), e.elm;
          };
        })({
          nodeOps: Ur,
          modules: [
        ...
        function Ei(t, e, n) {
          ...
          for (let e = 0, n = t.options.length; e < n; e++)
            if (((s = t.options[e]), o))
              (i = D(r, Ri(s)) > -1), s.selected !== i && (s.selected = i);
            else if (L(Ri(s), r))
              ...
              null == o.key
                ...
                : u(o.key)
                  ? 0 === String(o.key).indexOf(i)
                    ...
                    : i + o.key
                  : o.key;
            const s = ((o.data || (o.data = {})).transition = Vi(this)),
              a = this._vnode,
              c = zi(a);
            if (
        ...
        const Ji = E({ tag: String, moveClass: String }, Ui);
        delete Ji.mode;
        var qi = {
          props: Ji,
          beforeMount() {
        ...
        var Yi = { Transition: Xi, TransitionGroup: qi };
        (dr.config.mustUseProp = $r),
          (dr.config.isReservedTag = Ir),
          (dr.config.isReservedAttr = br),
          (dr.config.getTagNamespace = Lr),
          ...
          (dr.prototype.$mount = function (t, e) {
            ...
            })(this, (t = t && q ? Br(t) : void 0), e);
          }),
          q &&
            setTimeout(() => {
              V.devtools && st && st.emit("init", dr);
            }, 0);
        const ts = /\{\{((?:.|\r?\n)+?)\}\}/g,
          es = /[-.*+?^${}()|[\]\/\\]/g,
          ns = S((t) => {
        ...
        function qs(t, e) {
          ...
          for (let n = 0; n < zs.length; n++) t = zs[n](t, e) || t;
          return (
            (function (t) {
              const e = t.attrsList;
              let n, r, o, i, s, a, c, u;
              for (n = 0, r = e.length; n < r; n++)
                if (((o = i = e[n].name), (s = e[n].value), Os.test(o)))
                  if (
                    ((t.hasBindings = !0),
                    (a = Ys(o.replace(Os, ""))),
                    a && (o = o.replace(Ns, "")),
                    ...
                    (o = o.replace(Rs, "")),
                      ...
                      a &&
                        (a.prop &&
                          !u &&
                          ((o = A(o)), "innerHtml" === o && (o = "innerHTML")),
                        a.camel && !u && (o = A(o)),
                        a.sync &&
                          ((c = Co(s, "$event")),
                          u
                            ? _o(t, `"update:"+(${o})`, c, null, !1, 0, e[n], !0)
                            : (_o(t, `update:${A(o)}`, c, null, !1, 0, e[n]),
                              T(o) !== A(o) &&
                    ...
                    (u = !1),
                      c &&
                        ...
                        Es.test(c) && ((c = c.slice(1, -1)), (u = !0))),
                      go(t, o, i, s, c, u, a, e[n]);
                  }
                else
            ...
            model: function (t, e, n) {
              ...
              if ("select" === i)
                !(function (t, e, n) {
                  ...
                  (r = `${r} ${Co(e, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]")}`),
                ...
                !(function (t, e, n) {
                  ...
                  ho(
                    ...
                    _o(
                      t,
                      "change",
                      `var $$a=${e},$$el=$event.target,$$c=$$el.checked?(${i}):(${s});if(Array.isArray($$a)){var $$v=${r ? "_n(" + o + ")" : o},$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(${Co(e, "$$a.concat([$$v])")})}else{$$i>-1&&(${Co(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))")})}}else{${Co(e, "$$c")}}`,
                      null,
                      !0,
                    );
                })(t, r, o);
                ...
                !(function (t, e, n) {
                  ...
                  let l = Co(e, u);
                  a && (l = `if($event.target.composing)return;${l}`),
                    ho(t, "value", `(${e})`),
                    _o(t, c, l, null, !0),
                    (s || i) && _o(t, "blur", "$forceUpdate()");
                })(t, r, o);
              else if (!V.isReservedTag(i)) return So(t, r, o), !1;
              return !0;
            },
            text: function (t, e) {
        ...
        class xa {
          constructor(t) {
            (this.options = t),
              ...
              (this.directives = E(E({}, $a), t.directives));
        ...
        function Ca(t, e) {
          if (
            ...
            return ka(t, e);
          if (t.once && !t.onceProcessed) return Oa(t, e);
          ...
          if ("template" !== t.tag || t.slotTarget || e.pre) {
              ...
              })(t, e);
            {
              ...
              if (t.component)
                ...
                i &&
                  !1 !== i.__isScriptSetup &&
                  (o = Aa(i, t.tag) || Aa(i, A(t.tag)) || Aa(i, k(A(t.tag)))),
                  o || (o = `'${t.tag}'`);
        ...
        function ja(t, e, n, r) {
          ...
          function i(t) {
            return n ? n(t, e) : t.once ? Oa(t, e) : Ca(t, e);
          }
        }
        function Pa(t, e, n, r) {
          const o = t.for,
          ...
          return (
            (t.forProcessed = !0),
            `${r || "_l"}((${o}),function(${i}${s}${a}){return ${(n || Ca)(t, e)}})`
          );
        }
        function Ea(t, e) {
          let n = "{";
        ...
        function Ra(t, e) {
          ...
          if (t.if && !t.ifProcessed && !n) return Ta(t, e, Ra, "null");
          if (t.for && !t.forProcessed) return Pa(t, e, Ra);
          const r = "_empty_" === t.slotScope ? "" : String(t.slotScope),
            o = `function(${r}){return ${"template" === t.tag ? (t.if && n ? `(${t.if})?${Na(t, e) || "undefined"}:undefined` : Na(t, e) || "undefined") : Ca(t, e)}}`,
            i = r ? "" : ",proxy:true";
                ...
                ? (function (t, e) {
                    ...
                    for (let r = 0; r < t.length; r++) {
                      ...
                      if (1 === o.type) {
                        if (
                          Ia(o) ||
                          (o.ifConditions && o.ifConditions.some((t) => Ia(t.block)))
                        ) {
                          n = 2;
                          break;
                        }
        ...
        function La(t, e) {
          return 1 === t.type
            ...
            : 3 === t.type && t.isComment
              ...
              : (function (t) {
                  return `_v(${2 === t.type ? t.expression : Fa(JSON.stringify(t.text))})`;
                })(t);
        }
        function Da(t) {
          let e = "",
        ...
        const za =
          ((Va = function (t, e) {
            const n = (function (t, e) {
              (Bs = e.warn || fo),
                ...
                e.isReservedTag,
                (zs = po(e.modules, "transformNode")),
                (Vs = po(e.modules, "preTransformNode")),
                ...
                (function (t, e) {
                  ...
                  function l() {
                    ...
                    if (e) {
                      ...
                      for (
                        u(e[0].length);
                        !(r = t.match(hs)) && (o = t.match(ls) || t.match(us));

                      )
                        (o.start = c), u(o[0].length), (o.end = c), n.attrs.push(o);
                  ...
                  function f(t) {
                    ...
                    u ||
                      ...
                      (a = s)),
                      e.start && e.start(s, f, u, t.start, t.end);
                  }
                  function p(t, r, o) {
                    let i, s;
                  ...
                  chars(t, e, n) {
                    ...
                    if (
                      (t =
                        c || t.trim()
                          ? "script" === (u = s).tag || "style" === u.tag
                            ? t
                            : Fs(t)
                          : i.length
                            ? o
                              ? "condense" === o && Ls.test(t)
                                ? ""
                                : " "
                              : r
                                ? " "
          ...
          function (t) {
            ...
            return { compile: e, compileToFunctions: Ua(e) };
          });
        var Va;
        const { compile: Za, compileToFunctions: Ha } = za(ia);
        let Ka;
        function Xa(t) {
          return (
        ...
        (dr.prototype.$mount = function (t, e) {
          ...
          if (!n.render) {
            let e = n.template;
            if (e)
              if ("string" == typeof e) "#" === e.charAt(0) && (e = Ga(e));
              else {
            ...
            if (e) {
              const { render: t, staticRenderFns: r } = Ha(
                e,
                {
                  outputSourceRange: !1,
    ...
    (function () {
      ...
      var t = n(1317),
        ...
        r = function () {
          ...
          return e(
            "div",
            { staticClass: "ai1wm-tool-container", attrs: { id: t.toolId } },
            [
              e("h3", { staticClass: "mt-0 mb-0" }, [
                e("i", { class: t.icon }),
                t._v("\n    " + t._s(t.__t("name")) + "\n  "),
              ]),
              t._v(" "),
              e("p", { domProps: { textContent: t._s(t.__t("description")) } }),
              t._v(" "),
              e("div", { staticClass: "ai1wm-tool-buttons-container" }, [
                e(
                  "a",
                  {
                    staticClass: "ai1wm-main-btn",
                    attrs: { href: "#" },
                    on: {
                      click: function (e) {
                        return (
                          e.preventDefault(),
                          t.showResetConfirmation.apply(null, arguments)
                        );
                      },
                    },
                  },
                ...
                e(
                  "a",
                  {
                    staticClass: "ai1wm-secondary-btn",
                    attrs: { href: "#" },
                    on: {
                      click: function (e) {
                        return e.preventDefault(), t.createBackup.apply(null, arguments);
                      },
                    },
                  },
                  [e("span", { domProps: { textContent: t._s(t.__("backup_btn")) } })],
                ),
                t._v(" "),
                e("p", [
                  e("i", { staticClass: "ai1wm-icon-help" }),
                  t._v("\n      " + t._s(t.__t("help")) + "\n    "),
                ]),
              ]),
            ],
      ...
      var o = n(174),
        i = {
          methods: {
            __: function (t) {
              var e;
              return null !== (e = ai1wmve_locale[t]) && void 0 !== e ? e : t;
            },
          },
        };
      ...
      var a = s(
          {
            mixins: [i],
            props: {
              resetType: { type: String, required: !0 },
              icon: { type: String, required: !0 },
            },
            computed: {
              toolId: function () {
                return "ai1wm-reset-" + this.resetType;
              },
            },
            methods: {
              showResetConfirmation: function () {
                o.Z.$emit("ai1wm-show-reset-confirmation", this.resetType);
              },
              createBackup: function () {
                o.Z.$emit("ai1wm-show-create-snapshot", this.resetType);
              },
              __t: function (t) {
                var e;
                return null !== (e = this.__(this.resetType)[t]) && void 0 !== e ? e : t;
              },
            },
          },
          r,
            ...
            ? e(
                ...
                [
                  e(
                    ...
                    [
                      e("div", { staticClass: "ai1wm-reset-modal-container" }, [
                        e("h4", {
                          domProps: { textContent: t._s(t.__t("confirm_title")) },
                        }),
                        t._v(" "),
                        e("p", {
                          domProps: { textContent: t._s(t.__t("confirm_text")) },
                        }),
                        t._v(" "),
                        e("p", {
                          domProps: { innerHTML: t._s(t.pleaseRememberHtml) },
                          on: {
                            click: function (e) {
                              return (
                                e.preventDefault(), t.maybeShowCreateSnapshotModal(e)
                              );
                            },
                          },
                        }),
                        t._v(" "),
                        e("div", { staticClass: "ai1wm-reset-modal-input-container" }, [
                          e("label", { attrs: { for: "ai1wm_reset_password" } }, [
                            t._v(t._s(t.confirmPasswordLabel)),
                          ]),
                          t._v(" "),
                          e("input", {
                            directives: [
                            ...
                            attrs: {
                              id: "ai1wm_reset_password",
                              type: "password",
                              name: "ai1wm_reset_password",
                              placeholder: t.passwordPlaceholder,
                            },
                            domProps: { value: t.resetPassword },
                            on: {
                              input: function (e) {
                                e.target.composing || (t.resetPassword = e.target.value);
                              },
                            },
                          }),
                        ]),
                        t._v(" "),
                        e("div", { staticClass: "ai1wm-reset-modal-buttons-container" }, [
                          e("a", {
                            staticClass: "ai1wm-primary-btn",
                            attrs: { href: "#" },
                            domProps: { textContent: t._s(t.__("cancel")) },
                            on: {
                              click: function (e) {
                                e.preventDefault(), (t.isVisible = !1);
                              },
                            },
                          }),
                          t._v(" "),
                          e("button", {
                            staticClass: "ai1wm-secondary-btn",
                            attrs: { disabled: !t.resetPassword },
                            domProps: { textContent: t._s(t.__t("confirm_btn")) },
                            on: {
                              click: function (e) {
                                return e.preventDefault(), t.resetFilesByType();
                              },
                            },
                          }),
                        ]),
      ...
      var u = s(
          {
            mixins: [i],
            props: {
              confirmPasswordLabel: { type: String, required: !0 },
              pleaseRememberHtml: { type: String, required: !0 },
              passwordPlaceholder: { type: String, required: !0 },
            },
            data: function () {
              return {
                isVisible: !1,
                ...
                resetPassword: "",
                resetParams: [
                  { name: "ai1wm_manual_reset", value: 1 },
                  { name: "priority", value: 10 },
                ],
              };
            },
            mounted: function () {
              o.Z.$on("ai1wm-show-reset-confirmation", this.showModal);
            },
            methods: {
              showModal: function (t) {
                (this.isVisible = !0), (this.resetType = t);
              },
              maybeShowCreateSnapshotModal: function (t) {
                t.target.matches(".ai1wm-show-create-snapshot-link") &&
                  o.Z.$emit("ai1wm-show-create-snapshot", this.resetType);
              },
              resetFilesByType: function () {
                this.isVisible = !1;
                var t = this.resetParams.concat({
                  name: "ai1wm_reset_password",
                  value: this.resetPassword,
                });
                switch (this.resetType) {
                  case "plugins":
                    t = t.concat({ name: "ai1wm_reset_plugins", value: 1 });
                    break;
                  case "themes":
                    t = t.concat({ name: "ai1wm_reset_themes", value: 1 });
                    break;
                  case "media":
                    t = t.concat({ name: "ai1wm_reset_media", value: 1 });
                    break;
                  case "database":
                    t = t.concat({ name: "ai1wm_reset_database", value: 1 });
                    break;
                  default:
                    t = t.concat(
                      { name: "ai1wm_reset_plugins", value: 1 },
                      { name: "ai1wm_reset_themes", value: 1 },
                      { name: "ai1wm_reset_media", value: 1 },
                      { name: "ai1wm_reset_database", value: 1 },
                    );
                }
                (this.resetPassword = ""),
                  o.Z.$emit("show-reset-loader", {
                    params: t,
                ...
                [
                  e(
                    ...
                    [
                      e("div", { staticClass: "ai1wm-reset-modal-container" }, [
                        e("h4", {
                          domProps: { textContent: t._s(t.__("create_snapshot_title")) },
                        }),
                        t._v(" "),
                        e("div", { staticClass: "ai1wm-reset-modal-buttons-container" }, [
                          e("a", {
                            ...
                            on: {
                              click: function (e) {
                                return (
                                  e.preventDefault(), t.closeModal.apply(null, arguments)
                                );
                              },
                            },
                          }),
                          ...
                          e("a", {
                            staticClass: "ai1wm-secondary-btn",
                            attrs: { href: "#" },
                            domProps: { textContent: t._s(t.__("create_snapshot_btn")) },
                            on: {
                              click: function (e) {
                                return (
                                  e.preventDefault(),
                                  t.createSnapshot.apply(null, arguments)
                                );
                              },
                            },
                          }),
      ...
      var f = s(
          {
            mixins: [i],
            data: function () {
              return { isVisible: !1, resetType: null };
            },
            mounted: function () {
              o.Z.$on("ai1wm-show-create-snapshot", this.showModal);
            },
            methods: {
              closeModal: function () {
                (this.resetType = null), (this.isVisible = !1);
              },
              showModal: function (t) {
                (this.resetType = t), (this.isVisible = !0);
              },
              createSnapshot: function () {
                (this.isVisible = !1),
                  (document.getElementById("ai1wm-reset-label").value = this.resetType),
                  document.getElementById("ai1wm-create-backup").click(),
                  setTimeout(function () {
                    return (document.getElementById("ai1wm-reset-label").value = "");
                  }, 500);
              },
            },
          },
                ...
                [
                  e(
                    ...
                    [
                      e(
                        "div",
                        { staticClass: "ai1wm-reset-modal-container" },
                        [
                          e("h4", {
                          ...
                          t._v(" "),
                          e("p", { domProps: { innerHTML: t._s(t.message) } }),
                          t._v(" "),
                          t.isLoading
                            ? e("ai1wm-spinner", {
                          ...
                          e(
                            "div",
                            { staticClass: "ai1wm-reset-modal-buttons-container" },
                            [
                              t.isLoading
                                ? t._e()
                                : e("a", {
                                    staticClass: "ai1wm-primary-btn",
                                    attrs: { href: "#" },
                                    domProps: { textContent: t._s(t.doneBtnText) },
                                    on: {
                                      click: function (e) {
                                        return (
                                          e.preventDefault(),
                              ...
                              t.isError
                                ? e("a", {
                                    staticClass: "ai1wm-secondary-btn",
                                    attrs: { href: "#" },
                                    domProps: { textContent: t._s(t.__("retry")) },
                                    on: {
                                      click: function (e) {
                                        return (
                                          e.preventDefault(),
                                          t.retry.apply(null, arguments)
                                        );
                                      },
                                    },
                                  })
                              ...
                              t.isLoading
                                ? e("a", {
                                    staticClass: "ai1wm-secondary-btn",
                                    attrs: { href: "#" },
                                    domProps: { textContent: t._s(t.__("stop")) },
                                    on: {
                                      click: function (e) {
                                        return (
                                          e.preventDefault(),
                                          t.stopReset.apply(null, arguments)
                                        );
                                      },
                                    },
                                  })
        ...
        v = s(
          {
            ...
            mounted: function () {
              o.Z.$on("show-reset-loader", this.showModal),
                o.Z.$on("close-reset-loader", this.closeModal),
                o.Z.$on("change-reset-loader-text", this.changeLoaderText),
                o.Z.$on("change-reset-loader-done", this.changeLoaderDone),
                o.Z.$on("change-reset-loader-error", this.changeLoaderError);
            },
            methods: {
              showModal: function (t) {
                (this.isError = !1),
                  (this.isVisible = !0),
                  (this.resetType = t.resetType),
                  m.start(t.params);
              },
              closeModal: function () {
                this.isVisible = !1;
              },
              changeLoaderText: function (t) {
                (this.isLoading = !0),
                  (this.title = this.__("reset_in_progress")),
                  (this.message = t.message);
              },
              changeLoaderDone: function (t) {
                (this.isLoading = !1),
                  (this.title = t.title),
                  (this.message = t.message),
                  (this.doneBtnText = this.__("done"));
              },
              changeLoaderError: function (t) {
                (this.isError = !0),
                  (this.isLoading = !1),
                  (this.title = t.title),
                  (this.message = t.message),
                  (this.doneBtnText = this.__("close"));
              },
              stopReset: function () {
                (this.isVisible = !1), m.stopReset(!0);
              },
              retry: function () {
                this.closeModal(),
                  o.Z.$emit("ai1wm-show-reset-confirmation", this.resetType);
      ...
      e().component("ResetTool", a),
        e().component("ResetConfirmation", u),
        e().component("CreateSnapshotModal", f),
        e().component("ResetLoader", v),
        window.addEventListener("DOMContentLoaded", function () {
          new (e())({ el: "#ai1wm-reset-tools" });
        });
    })();
})();
