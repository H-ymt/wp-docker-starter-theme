...
<div class="ai1wm-container">
	<div class="ai1wm-row">
      ...
      admin_url("admin-post.php?action=ai1wmue_settings"),
    ); ?>">
						...
						<p>
							<div class="ai1wm-field">
								<label for="ai1wmue-backups">
									...
									<input style="width: 4.5em;" type="number" min="0" name="ai1wmue_backups" id="ai1wmue-backups" value="<?php echo intval(
           $backups,
         ); ?>" />
								</label>
								<?php _e(
          "backups. <small>Default: <strong>0</strong> unlimited</small>",
          AI1WMUE_PLUGIN_NAME,
        ); ?>
							</div>
							...
							<div class="ai1wm-field">
								<label for="ai1wmue-total">
									...
									<input style="width: 4.5em;" type="number" min="0" name="ai1wmue_total" id="ai1wmue-total" value="<?php echo intval(
           $total,
         ); ?>" />
								</label>
								<select style="margin-top: -2px;" name="ai1wmue_total_unit" id="ai1wmue-total-unit">
									<option value="MB" <?php echo strpos($total, "MB") !== false
           ? 'selected="selected"'
           : null; ?>><?php _e("MB", AI1WMUE_PLUGIN_NAME); ?></option>
									<option value="GB" <?php echo strpos($total, "GB") !== false
           ? 'selected="selected"'
           : null; ?>><?php _e("GB", AI1WMUE_PLUGIN_NAME); ?></option>
								</select>
							...
							<div class="ai1wm-field">
								<label for="ai1wmue-days">
									...
									<input style="width: 4.5em;" type="number" min="0" name="ai1wmue_days" id="ai1wmue-days" value="<?php echo intval(
           $days,
         ); ?>" />
								</label>
