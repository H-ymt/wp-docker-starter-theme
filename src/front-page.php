...
<main id="page-top">
  <div class="hero container">
    <h1 class="hero__title">Top page</h1>
    <p class="hero__text">
      wp-envとViteを使ったWordPressテーマ開発環境
    </p>
